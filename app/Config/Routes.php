...
$routes->post('/simpandept', 'Departement::simpan');
$routes->post('/updatedept', 'Departement::update');
$routes->post('/hapusdept/(:num)', 'Departement::hapus/$1');

$routes->get('/kategori', 'Kategori::index');
$routes->post('/simpankat', 'Kategori::simpan');
